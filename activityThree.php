  ...
  <div class="container">
    <center>
      <form method="post">
        ...
        <table>
          <tr>
            <td colspan="2" class="table-subheader">SUBMITTED DATA</td>
          </tr>
          <tr>
            <td class="label-cell">Surname</td><td><?php echo $surname; ?></td>
          </tr>
          <tr>
            <td class="label-cell">First Name</td><td><?php echo $fname; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Middle Name</td><td><?php echo $mname; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Date of Birth</td><td><?php echo $dateBirth; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Place of Birth</td><td><?php echo $placeBirth; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Sex</td><td><?php echo $sex; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Civil Status</td><td><?php echo $civilStatus; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Height</td><td><?php echo $height; ?>m</td>
          </tr>
          <tr>
            <td class="label-cell">Weight</td><td><?php echo $weight; ?>kg</td>
          </tr>
          <tr>
            <td class="label-cell">Blood Type</td><td><?php echo $bloodType; ?></td>
          </tr>
          <tr>
            <td class="label-cell">GSIS</td><td><?php echo $gsis; ?></td>
          </tr>
          <tr>
            <td class="label-cell">PAG-IBIG</td><td><?php echo $pagIbig; ?></td>
          </tr>
          <tr>
            <td class="label-cell">PhilHealth</td><td><?php echo $philHealth; ?></td>
          </tr>
          <tr>
            <td class="label-cell">SSS</td><td><?php echo $sss; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="label-cell">Residential Address</td>
            <td><?php echo $resStreet; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Citizenship</td>
            <td><?php echo $citizenship; ?></td>
          ...
          <tr>
            <td class="label-cell">Residential Street</td>
            <td><?php echo $resStreet; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Residential Barangay</td><td><?php echo $resBrgy; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Residential City</td><td><?php echo $resCity; ?></td>
          </tr>
          <tr>
            <td colspan="3" class="table-subheader">Permanent Adress</td>
          </tr>
          <tr>
            <td class="label-cell">Permanent Street</td><td><?php echo $perStreet; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Permanent Barangay</td><td><?php echo $perBrgy; ?></td>
          </tr>
          <tr>
            <td class="label-cell">Permanent City</td><td><?php echo $perCity; ?></td>
          </tr>
        </table>
    </center>
  </div>
